...
Upstream v1.10.0 remains the reference baseline. Selecting upstream retains upstream behavior. This fork changes defaults and safety handling as documented below. Experimental filters stay disabled unless explicitly enabled. Output recovery is not included in this prerelease.
